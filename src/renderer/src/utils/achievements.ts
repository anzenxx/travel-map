...
export type AchievementCategory = 'onboarding' | 'progress' | 'exploration' | 'collection' | 'functional'
...
const EUROPE_ISOS = ['DE','FR','IT','ES','PT','GB','PL','UA','RO','NL','BE','SE','NO','FI','DK','AT','CH','CZ','HU','SK','HR','BA','RS','ME','MK','SI','AL','GR','BG','TR','LT','LV','EE','LU','IE','IS','MT','CY','BY','MD','AM','AZ','GE','RU']
const ASIA_ISOS = ['CN','JP','KR','IN','ID','TH','VN','PH','MY','SG','BN','TL','LA','KH','MM','NP','BT','BD','LK','PK','AF','IR','IQ','SY','JO','LB','IL','PS','SA','AE','QA','KW','YE','OM','KZ','UZ','TM','TJ','KG','MN','AZ','GE','AM','TR','KP','TW']
const OCEANIA_ISOS = ['AU','NZ','PG','FJ','SB','VU','WS','TO','PW','FM','MH','KI','NR','TV']
const SCANDINAVIA_ISOS = ['DK', 'FI', 'IS', 'NO', 'SE']
const MEDITERRANEAN_ISOS = ['ES', 'FR', 'IT', 'SI', 'HR', 'BA', 'ME', 'AL', 'GR', 'TR', 'CY', 'SY', 'LB', 'IL', 'PS', 'EG', 'LY', 'TN', 'DZ', 'MA', 'MT']
const ISLAND_STATE_ISOS = ['AU', 'BS', 'BB', 'CV', 'CY', 'DM', 'DO', 'FJ', 'GD', 'HT', 'IS', 'IE', 'JM', 'JP', 'KI', 'LK', 'MG', 'MT', 'MU', 'MV', 'NR', 'NZ', 'PH', 'SG', 'TT', 'WS', 'TO', 'TV', 'VU']
const LANDLOCKED_ISOS = ['AD', 'AF', 'AM', 'AT', 'AZ', 'BF', 'BI', 'BT', 'BY', 'CF', 'CH', 'CZ', 'ET', 'HU', 'KZ', 'KG', 'LA', 'LI', 'LS', 'LU', 'MD', 'MK', 'ML', 'MN', 'MW', 'NE', 'NP', 'PY', 'RS', 'RW', 'SK', 'SM', 'SS', 'SZ', 'TD', 'TJ', 'TM', 'UG', 'UZ', 'VA', 'ZM', 'ZW']
const COASTAL_ISOS = ['AL','AO','AR','AU','BD','BE','BG','BR','CA','CL','CN','CO','CR','DE','DK','DO','EC','EG','ES','FI','FR','GB','GE','GH','GR','HR','ID','IE','IL','IN','IS','IT','JM','JP','KE','KR','LB','LK','LT','LV','MA','ME','MG','MM','MX','MY','NG','NL','NO','NZ','OM','PA','PE','PH','PL','PT','RO','RU','SA','SE','SG','SI','SO','TH','TN','TR','TW','TZ','UA','US','UY','VE','VN','ZA']
...
function countByIsoSet(context: AchievementContext, isos: string[], predicate: (status: CountryStatus | undefined) => boolean): number {
