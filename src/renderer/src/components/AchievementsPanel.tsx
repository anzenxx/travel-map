...
export default function AchievementsPanel() {
  ...
  const { countries, usaMode, usStates, achievementEvents, unlockedAchievements, setActiveTab } = useStore()
                  ...
                  <div style={{
                    ...
                    <div style={{
                      ...
                      <div style={{
                        ...
                        height: '100%',
                        borderRadius: 999,
                        background: unlocked ? 'var(--theme-accent-soft)' : 'var(--theme-text-soft)'
                      }} />
                    </div>
                    <div style={{
                      flexShrink: 0,
