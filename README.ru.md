...
- Интерактивная D3-карта мира с zoom, pan, подписями, цветовыми статусами и поиском стран/городов.
- Electron-архитектура с разделением main, preload и renderer-слоев, связанных через типизированный IPC.
- Локальное SQLite-хранилище для travel-данных, поездок, фото, тегов, настроек и прогресса достижений.
- Многоязычный интерфейс на i18next: английский, немецкий, русский и украинский.
- Полный travel-tracking workflow: статистика, таймлайн, достижения, local-first privacy и PNG-экспорт карты.
...
Последний Windows installer можно скачать в [GitHub Releases](https://github.com/anzenxx/Atlas-Travel/releases).
